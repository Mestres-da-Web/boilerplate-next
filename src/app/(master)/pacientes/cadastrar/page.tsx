...
const CadastrarPacientePage = () => {
  const router = useRouter();
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [obsLength, setObsLength] = useState(0);
  const [vincularFamiliar, setVincularFamiliar] = useState('nao');
  const [familiares, setFamiliares] = useState<
    { id: string; nome: string; parentesco: string }[]
  >([]);
  ...
  const handleParentescoChange = (id: string, parentesco: string) => {
    setFamiliares(prev =>
      prev.map(f => (f.id === id ? { ...f, parentesco } : f)),
    );
  };
  ...
  const onSubmit = async (data: PacienteForm) => {
    try {
      ...
      console.log('Cadastrar paciente:', data);
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <InfoPessoalGrid>
              ...
              <PhotoFieldsCol>
                ...
                <FieldGroup>
                  ...
                  <Input placeholder="00.000.000-00" {...register('rg')} />
                </FieldGroup>
          ...
          <Section>
            ...
            <Row2>
              ...
              <FieldGroup>
                <Label>Estado *</Label>
                <Input placeholder="Digite o estado" {...register('estado')} />
              </FieldGroup>
            </Row2>
            ...
            <Row2 style={{ marginTop: '1rem' }}>
              <FieldGroup>
                <Label>Cidade *</Label>
                <Input placeholder="Digite a cidade" {...register('cidade')} />
              </FieldGroup>
              <FieldGroup>
                <Label>Bairro *</Label>
            ...
            <Row2 style={{ marginTop: '1rem' }}>
              ...
              <FieldGroup>
                <Label>Número *</Label>
                <Input placeholder="Digite o número" {...register('numero')} />
              </FieldGroup>
            </Row2>
